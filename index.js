...
const sessdata = config.SESSION_ID.replace("ROCHANA-MD~", '');
...
console.log('ROCHANA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ ROCHANA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ rochana ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ group ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://chat.whatsapp.com/ES2ooUhtxicEynbon2GTyr*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: https://ibb.co/YB4NpsTt }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("+94766443560")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("+94766443560")){
